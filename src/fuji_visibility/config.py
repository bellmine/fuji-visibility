...
GOOD_HUMIDITY_THRESHOLD = 80.0

# Phase 3.1 field-level evidence configuration. Keep the old names above as
# compatibility aliases for the scoring/export layers.
MIN_PROXY = GOOD_PROXY_THRESHOLD
MIN_FULL_PROXY_MODELS = 2
MAX_PROXY_SPREAD_FOR_STRONG_SUPPORT = 15.0
MAX_PROXY_SPREAD_FOR_WEAK_SUPPORT = 25.0
GOOD_MID_CLOUD_MAX = GOOD_MID_CLOUD_THRESHOLD
GOOD_VISIBILITY_MIN_KM = GOOD_VISIBILITY_THRESHOLD_KM
GOOD_PRECIP_MAX = GOOD_PRECIP_THRESHOLD
GOOD_HUMIDITY_MAX = GOOD_HUMIDITY_THRESHOLD
FIELD_SUPPORT_STRONG_MIN_MODELS = 3
FIELD_SUPPORT_STRONG_GOOD_RATIO = 0.75
FIELD_SUPPORT_MODERATE_MIN_MODELS = 2
FIELD_SUPPORT_MODERATE_GOOD_RATIO = 0.60
